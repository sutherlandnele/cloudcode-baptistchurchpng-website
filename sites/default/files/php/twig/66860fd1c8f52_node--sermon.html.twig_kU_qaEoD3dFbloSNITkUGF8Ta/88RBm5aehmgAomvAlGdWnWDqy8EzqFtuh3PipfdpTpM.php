...
/* themes/openchurch_theme/templates/content/node--sermon.html.twig */
class __TwigTemplate_06fee85a16fa1198e502733ae7102ce0 extends Template
{
    private $source;
    private $macros = [];
...
<article";
  ...
  <div";
        // line 90
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["content_attributes"] ?? null), "addClass", ["node__content"], "method", false, false, true, 90), 90, $this->source), "html", null, true);
        yield ">
    ";
        // line 91
        if (CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "field_video", [], "any", false, false, true, 91)) {
            // line 92
            yield "      <div class=\"mb-4\">
        ";
            // line 93
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "field_video", [], "any", false, false, true, 93), 93, $this->source), "html", null, true);
            yield "
      </div>
    ";
        }
        // line 96
        yield "    ";
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->withoutFilter($this->sandbox->ensureToStringAllowed(($context["content"] ?? null), 96, $this->source), "field_video"), "html", null, true);
        yield "
  </div>
...
";
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["node", "view_mode", "attributes", "title_prefix", "label", "page", "title_attributes", "title_suffix", "content_attributes", "content"]);        return; yield '';
    }
    ...
    {
        return "themes/openchurch_theme/templates/content/node--sermon.html.twig";
    }
    ...
    {
        return array (  90 => 96,  84 => 93,  81 => 92,  79 => 91,  75 => 90,  69 => 88,  61 => 86,  59 => 85,  55 => 84,  50 => 82,  47 => 81,  45 => 77,  44 => 76,  43 => 75,  42 => 74,  41 => 73,  40 => 71,);
    }

    public function getSourceContext()
    {
        return new Source("", "themes/openchurch_theme/templates/content/node--sermon.html.twig", "/var/www/html/pngbaptist/themes/openchurch_theme/templates/content/node--sermon.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("set" => 71, "if" => 85);
        static $filters = array("clean_class" => 73, "escape" => 82, "without" => 96);
