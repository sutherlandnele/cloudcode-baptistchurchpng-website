...
/* themes/openchurch_theme/templates/block/block.html.twig */
class __TwigTemplate_f74a2908a39df6a608363971ad2a6626 extends Template
{
    private $source;
    private $macros = [];
...
($context["plugin_id"] ?? null), 33, $this->source)))];
  ...
  ";
        ...
        if (($context["label"] ?? null)) {
            // line 39
            yield "    <h2";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["title_attributes"] ?? null), "addClass", ["mb-4 text-center"], "method", false, false, true, 39), 39, $this->source), "html", null, true);
            yield ">";
...
";
  ...
  ";
    ...
    {
        return "themes/openchurch_theme/templates/block/block.html.twig";
    }
    ...
    {
        return new Source("", "themes/openchurch_theme/templates/block/block.html.twig", "/var/www/html/pngbaptist/themes/openchurch_theme/templates/block/block.html.twig");
    }
