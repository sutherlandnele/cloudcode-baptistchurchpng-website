...
/* themes/openchurch_theme/templates/block/block--quote.html.twig */
class __TwigTemplate_7e46dffa1bdbc2546a7fa4e65a74f36c extends Template
{
    private $source;
    private $macros = [];
...
";
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["configuration", "plugin_id", "attributes", "title_prefix", "label", "title_suffix", "content"]);        return; yield '';
    }
    ...
    public function block_content($context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 43
        yield "    <div class=\"container-fluid bg-light mt-2 mb-5\">
      <figure class=\"container-fluid text-center p-5\">
        <blockquote class=\"blockquote mb-4\">
          <p class=\"fs-3\"><i class=\"bi bi-quote fs-1 text-secondary\" style=\"position: relative; top: 5px;\"></i>";
        // line 46
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "field_summary", [], "any", false, false, true, 46), 46, $this->source), "html", null, true);
        yield "</p>
        </blockquote>
        <figcaption class=\"blockquote-footer fs-4\">
          ";
        // line 49
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "field_author", [], "any", false, false, true, 49), 49, $this->source), "html", null, true);
        yield "
        </figcaption>
      </figure>
    </div>
  ";
    ...
    {
        return "themes/openchurch_theme/templates/block/block--quote.html.twig";
    }
    ...
    {
        return array (  91 => 49,  85 => 46,  80 => 43,  76 => 42,  69 => 54,  67 => 42,  62 => 41,  56 => 39,  54 => 38,  50 => 37,  45 => 36,  43 => 33,  42 => 32,  41 => 30,);
    }

    public function getSourceContext()
    {
        return new Source("", "themes/openchurch_theme/templates/block/block--quote.html.twig", "/var/www/html/pngbaptist/themes/openchurch_theme/templates/block/block--quote.html.twig");
    }
